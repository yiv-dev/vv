 ...
 * @typedef {{ link?: string, country?: string, title?: string, categories?: string[], rating?: string, details?: string, brand?: string, info?: string[], reviews?: Record<string, string> }} Product
